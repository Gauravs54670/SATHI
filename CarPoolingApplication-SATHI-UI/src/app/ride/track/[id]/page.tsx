                  ...
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <h1 className="text-2xl font-black text-white tracking-tightest flex items-center gap-3">
                           Track Ride
                           <span className={`px-2 py-0.5 rounded-lg text-[10px] uppercase tracking-widest border ${request.rideRequestStatus === 'ACCEPTED' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' : 'bg-indigo-500/10 text-indigo-400 border-indigo-500/30'
                              }`}>
                              ...
                              <div className="flex justify-center gap-2">
                                 {[1, 2, 3, 4, 5].map((star) => (
                                    <button
                                       ...
                                       className={`w-10 h-10 rounded-xl transition-all active:scale-90 ${star <= driverRating
